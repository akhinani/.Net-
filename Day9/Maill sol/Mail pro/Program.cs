...
namespace Mail
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Mail m1 = new Mail(int.Parse(mail1[0]), mail1[1], mail1[2], mail1[3], mail1[4], Convert.ToDateTime(mail1[5]),
            ...
            Mail m2 = new Mail(int.Parse(mail2[0]), mail2[1], mail2[2], mail2[3], mail2[4], Convert.ToDateTime(mail2[5]),
